...
ТРЕБОВАНИЯ:
1. Используй данные из базы знаний (program, pain, content_plan)
2. Копируй стиль и структуру из примера контента
3. Верни ТОЛЬКО валидный JSON объект по схеме data_schema
4. Для списков (speakers, schedule) — найди ВСЕ элементы в базе знаний
5. Не выдумывай данные — используй только то что есть в базе знаний
