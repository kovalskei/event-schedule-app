...
**src/pages/TemplateConverter.tsx**  
**⚡ НОВАЯ ФУНКЦИЯ - Преобразователь HTML → Mustache**
- Загрузка HTML файла или вставка кода
- Загрузка демо-шаблонов (test-simple-template.html, test-complex-template.html)
...
- Две колонки:
  - **Слева**: Оригинальный HTML + превью
  - **Справа**: Преобразованный Mustache + превью с переменными
...
const EVENTS_MANAGER_URL = 'https://functions.poehali.dev/b56e5895...';
const TEMPLATE_GENERATOR_URL = 'https://functions.poehali.dev/616d6890...';
const GENERATE_DRAFTS_URL = 'https://functions.poehali.dev/90b50454...';
const STYLE_VALIDATOR_URL = 'https://functions.poehali.dev/7fe04096...';
const INDEX_KNOWLEDGE_URL = 'https://functions.poehali.dev/814ac16e...';
```
